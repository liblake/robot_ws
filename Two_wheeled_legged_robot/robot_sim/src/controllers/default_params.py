...
def params_to_dict(params: CombinedParams) -> dict[str, Any]:
    ...
    return {
        "vmc": {
            ...
            "flight_attitude_diff_enable": params.vmc.flight_attitude_diff_enable,
            ...
            "flight_tuck_enable": params.vmc.flight_tuck_enable,
            "flight_tuck_height": params.vmc.flight_tuck_height,
            "flight_tuck_kp": params.vmc.flight_tuck_kp,
            "flight_tuck_kd": params.vmc.flight_tuck_kd,
...
def params_from_dict(d: dict[str, Any]) -> CombinedParams:
    ...
    return CombinedParams(
        vmc=VmcParams(
            ...
            flight_attitude_diff_enable=vmc_data.get("flight_attitude_diff_enable", True),
        ...
        flight_tuck_enable=vmc_data.get("flight_tuck_enable", True),
        flight_tuck_height=vmc_data.get("flight_tuck_height", 0.35),
        flight_tuck_kp=vmc_data.get("flight_tuck_kp", 200.0),
        flight_tuck_kd=vmc_data.get("flight_tuck_kd", 8.0),
